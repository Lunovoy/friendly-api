...
func (s *FriendlistService) AddTagsToFriendlist(userID, friendlistID uuid.UUID, tagIDs []models.AdditionTag) ([]uuid.UUID, error) {
	return s.repo.AddTagsToFriendlist(userID, friendlistID, tagIDs)
}
