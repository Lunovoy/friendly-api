...
func (s *EventService) AddFriendsToEvent(userID, eventID uuid.UUID, friendIDs []uuid.UUID) error {
...
func (s *EventService) Update(userID, eventID uuid.UUID, event models.Event) error {
